...
export default class productService{
    ...
    getPage = async (page) => {
        ...
        result.prevLink = result.hasPrevPage ? `http://localhost:8080/api/products/pages?page=${result.prevPage}` : '';
        result.nextLink = result.hasNextPage ? `http://localhost:8080/api/products/pages?page=${result.nextPage}` : '';
